...
!insertmacro LANGFILE "Korean" "Korean-rul"
!define EUL_RUL	"를"

!ifdef MUI_WELCOMEPAGE
  ${LangFileString} MUI_TEXT_WELCOME_INFO_TITLE "$(^NameDA) 설치를 시작합니다."
  ${LangFileString} MUI_TEXT_WELCOME_INFO_TEXT "이 프로그램은 당신의 컴퓨터에 $(^NameDA)${EUL_RUL} 설치할 것입니다.$\r$\n$\r$\n설치를 시작하기 전 가능한 한 모든 프로그램을 종료하여 주시기 바랍니다. 이는 재부팅을 하지 않고서도 시스템 파일을 수정할 수 있게 해줍니다.$\r$\n$\r$\n$_CLICK"
!endif

!ifdef MUI_UNWELCOMEPAGE
  ${LangFileString} MUI_UNTEXT_WELCOME_INFO_TITLE "$(^NameDA) 제거를 시작합니다."
  ${LangFileString} MUI_UNTEXT_WELCOME_INFO_TEXT "이 프로그램은 당신의 컴퓨터에서 $(^NameDA)${EUL_RUL} 제거할 것입니다.$\r$\n$\r$\n제거를 시작하기 전에 $(^NameDA)${EUL_RUL} 종료하여 주시기 바랍니다.$\r$\n$\r$\n$_CLICK"
!endif

!ifdef MUI_LICENSEPAGE
  ${LangFileString} MUI_TEXT_LICENSE_TITLE "사용권 계약"
  ${LangFileString} MUI_TEXT_LICENSE_SUBTITLE "사용권 계약 내용을 살펴보시기 바랍니다."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "$\r$\n내용에 동의하신다면 [동의함]을 눌러 주세요."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "내용에 동의하셨다면 아래 사항을 선택해 주세요. $(^NameDA)${EUL_RUL} 설치하기 위해서는 반드시 내용에 동의하셔야 합니다. $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "내용에 동의하셨다면 첫 번째 사항을 선택해 주세요. $(^NameDA)${EUL_RUL} 설치하기 위해서는 반드시 내용에 동의하셔야 합니다. $_CLICK"
!endif

!ifdef MUI_UNLICENSEPAGE
  ${LangFileString} MUI_UNTEXT_LICENSE_TITLE "사용권 계약 동의"
  ${LangFileString} MUI_UNTEXT_LICENSE_SUBTITLE "$(^NameDA)${EUL_RUL} 제거하시기 전에 사용권 계약 내용을 살펴보시기 바랍니다."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "내용에 동의하셨다면 '동의함'을 눌러 주세요. $(^NameDA)${EUL_RUL} 제거하기 위해서는 반드시 내용에 동의하셔야 합니다."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "내용에 동의하셨다면 아래 사항을 선택해 주세요. $(^NameDA)${EUL_RUL} 제거하기 위해서는 반드시 내용에 동의하셔야 합니다. $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "내용에 동의하셨다면 첫 번째 사항을 선택해 주세요. $(^NameDA)${EUL_RUL} 제거하기 위해서는 반드시 내용에 동의하셔야 합니다. $_CLICK"
!endif

!ifdef MUI_LICENSEPAGE | MUI_UNLICENSEPAGE
  ${LangFileString} MUI_INNERTEXT_LICENSE_TOP "계약 내용의 나머지 부분을 보려면 [Page Down] 키를 눌러 주세요."
!endif
...
!ifdef MUI_DIRECTORYPAGE
  ...
  ${LangFileString} MUI_TEXT_DIRECTORY_SUBTITLE "$(^NameDA)${EUL_RUL} 설치할 폴더를 선택해 주세요."
!endif

!ifdef MUI_UNDIRECTORYSPAGE
  ${LangFileString} MUI_UNTEXT_DIRECTORY_TITLE "제거 위치 선택"
  ${LangFileString} MUI_UNTEXT_DIRECTORY_SUBTITLE "$(^NameDA)${EUL_RUL} 제거할 폴더를 선택해 주세요."
!endif

!ifdef MUI_INSTFILESPAGE
  ${LangFileString} MUI_TEXT_INSTALLING_TITLE "설치 중"
  ${LangFileString} MUI_TEXT_INSTALLING_SUBTITLE "$(^NameDA)${EUL_RUL} 설치하고 있습니다. 잠시만 기다려 주세요."
  ${LangFileString} MUI_TEXT_FINISH_TITLE "설치 완료"
  ${LangFileString} MUI_TEXT_FINISH_SUBTITLE "$(^NameDA) 설치가 성공적으로 완료되었습니다."
...
!ifdef MUI_UNINSTFILESPAGE
  ...
  ${LangFileString} MUI_UNTEXT_UNINSTALLING_SUBTITLE "$(^NameDA)${EUL_RUL} 제거하는 동안 잠시 기다려 주시기 바랍니다."
